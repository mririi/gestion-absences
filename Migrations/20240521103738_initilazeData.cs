...
namespace GestionAbscences.Migrations
{
    ...
    public partial class initilazeData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ProfessorSubjectAssignments",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProfessorSubjectAssignments", x => x.AssignmentId);
                    table.ForeignKey(
                        name: "FK_ProfessorSubjectAssignments_Professors_ProfessorId",
                        column: x => x.ProfessorId,
                        principalTable: "Professors",
                        principalColumn: "ProfessorId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProfessorSubjectAssignments_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "SubjectId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProfessorSubjectAssignments_ProfessorId",
                table: "ProfessorSubjectAssignments",
                column: "ProfessorId");

            migrationBuilder.CreateIndex(
                name: "IX_ProfessorSubjectAssignments_SubjectId",
                table: "ProfessorSubjectAssignments",
                column: "SubjectId");
